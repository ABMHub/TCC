...
class LCANet():
  ...
  def load_data(self, x_path : str, y_path : str, batch_size : int = 32, validation_slice : float = 0.2, validation_only = False, recalc_standardization = False):
    ...
    """
    self.data = get_training_data(x_path, y_path, batch_size = batch_size, val_size = validation_slice, validation_only = validation_only, recalc_standardization = recalc_standardization)
